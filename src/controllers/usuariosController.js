...
// SDK do Resend — usa HTTPS (porta 443), nunca bloqueada por provedores de cloud.
// Alternativas SMTP (porta 465/587) são frequentemente bloqueadas em planos free.
...
class usuariosController {
    ...
    static async recuperarConta(req, res) {
        try {
            ...
            // FRONTEND_URL no .env permite trocar entre localhost e produção
            ...
            await resend.emails.send({
                ...
                html: `
                    <div style="font-family: Arial, sans-serif; color: #333; max-width: 500px; margin: 0 auto;">
                        <h2>Olá! Esqueceu sua senha?</h2>
                        <p>Não se preocupe, a equipe do ideias de sabor está aqui para ajudar. Clique no botão abaixo para criar uma nova senha:</p>
